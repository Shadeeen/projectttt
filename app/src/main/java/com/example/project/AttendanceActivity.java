...
public class AttendanceActivity extends AppCompatActivity {
    ...
    private void fetchStudents() {
        ...
        String url = "http://10.0.2.2:80/school_backend/get_students.php?user_id=" + userId;
                ...
                response -> {
                    try {
                        ...
                        for (int i = 0; i < array.length(); i++) {
                            ...
                            students.add(new Student1(id, name));
                        }
    ...
    private void submitAttendance() {
        String url = "http://10.0.2.2:80/school_backend/submit_attendance.php";
