...
public class ClassAdapter1 extends RecyclerView.Adapter<ClassAdapter1.ClassViewHolder> {

    private Context context;
    private List<ClassItem> classList;

    public ClassAdapter1(Context context, List<ClassItem> classList) {
    ...
    public ClassViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.class_card1, parent, false);
