...
public class AssignmentAdapter1 extends RecyclerView.Adapter<AssignmentAdapter1.ViewHolder> {

    private final List<Assignment> assignments;

    public AssignmentAdapter1(List<Assignment> assignments) {
    ...
    private void fetchSubmissionData(String assignmentTitle, ViewHolder holder) {
        String url = "http://10.0.2.2:80/school_backend/get_submissions.php?assignment_title=" + Uri.encode(assignmentTitle);
