...
public class EnterMarksActivity extends AppCompatActivity {
    ...
    private void loadTeacherClasses() {
        String url = "http://10.0.2.2:80/school_backend/get_taught_classes.php?user_id=" + userId;
    ...
    private void loadStudentsFromDatabase(String className, String type) {
        ...
        String url = "http://10.0.2.2:80/school_backend/get_student_for_class.php?user_id=" + userId + "&class_name=" + className + "&type=" + type ;
